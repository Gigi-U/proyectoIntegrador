...
const contenidoEvento = `
    ...
    <div><span style="background-color: yellow;font-size:20px; font-weight:bold;">👷🏻‍♀️  ⚠️PÁGINA EN CONSTRUCCIÓN⚠️ 👷🏻</span></div>
    ...
    <p class="event-info">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus eos rem doloribus dignissimos porro consequuntur vel dolore non! Minus incidunt vel accusamus quo reiciendis quam iste aut itaque nemo odit!
    </p>
